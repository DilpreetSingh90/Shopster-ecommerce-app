...
const UpdateAddress = ({ id, address }) => {
  ...
  return (
    <>
      <section className="mt-12 md:mt-20 lg:mt-10 py-6 md:py-8 lg:py-10">
          ...
          <div className="flex md:flex-row -mx-4">
            ...
            <main className="w-2/3 md:w-2/3 lg:w-3/4 px-4">
              <div
                ...
                className="mb-20 p-2 md:p-0 lg:p-0 mx-auto rounded bg-white shadow-lg"
              >
                <form className="text-md md:text-xl lg:text-xl" onSubmit={submitHandler}>
                  <h2 className="mb-5 text-xl md:text-2xl lg:text-3xl font-semibold">
                    Update Address
                  </h2>
