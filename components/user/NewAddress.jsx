...
const NewAddress = () => {
  ...
  return (
    <>
      <section className="mt-16 md:mt-20 lg:mt-4 py-10">
          ...
          <div className="flex md:flex-row -mx-4">
            ...
            <main className="w-2/3 md:w-2/3 lg:w-3/4 px-4">
              <div
                ...
                className="mb-20 p-2 md:p-7 mx-auto rounded bg-white shadow-lg"
              >
                <form className="text-md md:text-lg lg:text-lg" onSubmit={submitHandler}>
                  <h2 className="mb-5 text-xl md:text-2xl lg:text-2xl font-semibold">
                    Add New Address
                  </h2>

                  <div className="mb-2 md:mb-4 lg:mb-4 md:col-span-2">
                  ...
                  <div className="grid md:grid-cols-2 gap-x-3">
                    <div className="mb-2 md:mb-4 lg:mb-4 md:col-span-1">
