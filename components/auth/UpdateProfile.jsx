    ...
    <>
      ...
      >
        <form className="text-md md:text-xl lg:text-xl" onSubmit={submitHandler}>
          <h2 className="mb-5 text-xl md:text-2xl lg:text-3xl font-semibold">Update Profile</h2>
          ...
          <div className="mb-2 md:mb-4 lg:mb-4">
            ...
            <div className="mb-0 md:mb-4 lg:mb-4 flex flex-col md:flex-row">
              <div className="flex items-center mb-0 md:mb-4 lg:mb-4 space-x-3 mt-4 cursor-pointer md:w-1/5 lg:w-1/4">
                <img className="w-14 h-14 rounded-full" src={avatarPreview} />
              </div>
              <div className="md:w-2/3 lg:w-80">
                <input
                  className="form-control block w-full px-1 py-0.5 md:px-2 md:py-1.5 text-base font-normal text-gray-700 bg-white bg-clip-padding border border-solid border-gray-300 rounded transition ease-in-out m-0 focus:text-gray-700 focus:bg-white focus:border-blue-600 focus:outline-none mt-6"
                  type="file"
                  id="formFile"
                  onChange={onChange}
                />
