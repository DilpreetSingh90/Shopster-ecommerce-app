                ...
                <div className="flex justify-evenly text-center">
                    ...
                    <ul className="">
                        <li className="inline-block vertical-align-top m-[5px 0 5px 15px]">
                            <svg className="w-auto h-8 stroke-transparent inline-block vertical-align-middle" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" width="38" height="24" ariaLabelledby="pi-visa">
                        ...
                        <li className="inline-block vertical-align-top m-[5px 0 5px 15px]">
                            <svg className="w-auto h-8 stroke-transparent inline-block vertical-align-middle" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" role="img" width="38" height="24" ariaLabelledby="pi-master">
                        ...
                        <li className="inline-block vertical-align-top m-[5px 0 5px 15px]">
                            <svg className="w-auto h-8 stroke-transparent inline-block vertical-align-middle" viewBox="0 0 38 24" xmlns="http://www.w3.org/2000/svg" width="38" height="24" role="img" ariaLabelledby="pi-maestro">
                        ...
                        <li className="inline-block vertical-align-top m-[5px 0 5px 15px]">
                            <svg className="w-auto h-8 stroke-transparent inline-block vertical-align-middle" xmlns="http://www.w3.org/2000/svg" role="img" viewBox="0 0 38 24" width="38" height="24" ariaLabelledby="pi-american_express">
                        ...
                        <li className="inline-block vertical-align-top m-[5px 0 5px 15px]">
                            <svg className="w-auto h-8 stroke-transparent inline-block vertical-align-middle" version="1.1" xmlns="http://www.w3.org/2000/svg" role="img" x="0" y="0" width="38" height="24" viewBox="0 0 165.521 105.965" ariaLabelledby="pi-apple_pay">
