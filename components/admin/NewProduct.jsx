...
const NewProduct = () => {
  ...
  return (
    <section className="container max-w-3xl p-1 lg:p-0 md:p-0 mx-auto">
      <h1 className="mb-3 text-xl md:text-3xl font-semibold text-black mb-2 md:mb-8 lg:mb-8">
        Create New Product
      </h1>
      ...
      <form className="text-md md:text-xl lg:text-xl" onSubmit={submitHandler}>
        ...
        <div className="mb-2 md:mb-4 lg:mb-4 mt-2 md:mt-5">
        ...
        <div className="grid md:grid-cols-2 gap-x-2 mt-2 md:mt-5">
          <div className="mb-2 md:mb-4 lg:mb-4">
          ...
          <div className="mb-2 md:mb-4 lg:mb-4">
            ...
            <div className="relative">
              <select
                className="block appearance-none border border-gray-200 bg-gray-100 rounded-md px-1 md:px-3 lg:px-3 py-1 md:py-2 lg:py-2 hover:border-gray-400 focus:outline-none focus:border-gray-400 w-full"
                name="category"
                value={category}
                onChange={onChange}
                required
