          ...
          <div className="flex flex-col md:flex-row gap-4 lg:gap-8">
            <main className="md:w-2/3">
              <article className="border border-gray-200 bg-white shadow-sm rounded p-4 lg:p-6 mb-5">
                <h2 class="text-xl md:text-2xl lg:text-3xl font-semibold mb-5">Shipping information</h2>
            ...
            <aside className="md:w-1/3">
              <article className="text-gray-600" style={{ maxWidth: "350px" }}>
                ...
                <div className="flex items-center w-full justify-center space-x-2 mt-2 md:mt-6 mt-10 mb-10">
                  <Link
                    href="/cart"
                    className="w-1/2 py-2 text-center inline-block text-white bg-red-600 shadow-sm border border-transparent cursor-pointer rounded-md hover:bg-red-700"
                  >
                    Cancel
                  </Link>
                  <a
                    className="w-1/2 py-2 text-center inline-block text-white bg-green-600 border border-transparent rounded-md hover:bg-green-700 cursor-pointer"
